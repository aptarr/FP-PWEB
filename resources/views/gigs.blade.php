                        ...
                        <div class="flex border-t border-gray-300 mt-5 py-2 font-semibold">
                            <div class="w-full">
                                ...
                                <div class="font-normal flex items-center">
                                    ...
                                    <img style="filter: grayscale(100%); width: 40px; height: 40px;"  data-v-3d87c57a="" data-testid="detail-kost-facility__icon" alt="Lemari Baju" class="detail-kost-facility-item__icon-image" data-src="https://static.mamikos.com/uploads/tags/egu43HCg.png" src="https://static.mamikos.com/uploads/tags/egu43HCg.png" lazy="loaded">
                                    @endif

                                    @if($fasilitas === 'Air Panas')
                                    <img style="filter: grayscale(100%); width: 40px; height: 40px;" data-v-3d87c57a="" data-testid="detail-kost-facility__icon" alt="Air panas" class="detail-kost-facility-item__icon-image" data-src="https://static.mamikos.com/uploads/tags/zKWuh5ma.png" src="https://static.mamikos.com/uploads/tags/zKWuh5ma.png" lazy="loaded">
                                    @endif

                                    @if($fasilitas === 'AC')
                                    <img style="filter: grayscale(100%); width: 40px; height: 40px;" data-v-3d87c57a="" data-testid="detail-kost-facility__icon" alt="AC" class="detail-kost-facility-item__icon-image" data-src="https://static.mamikos.com/uploads/tags/lqunlyi8.png" src="https://static.mamikos.com/uploads/tags/lqunlyi8.png" lazy="loaded">
                                    @endif

                                    @if($fasilitas === 'Kursi')
                                    <img style="filter: grayscale(100%); width: 40px; height: 40px;" data-v-3d87c57a="" data-testid="detail-kost-facility__icon" alt="Kursi" class="detail-kost-facility-item__icon-image" data-src="https://static.mamikos.com/uploads/tags/MB9milt9.png" src="https://static.mamikos.com/uploads/tags/MB9milt9.png" lazy="loaded">
                                    @endif

                                    @if($fasilitas === 'Jendela')
                                    <img style="filter: grayscale(100%); width: 40px; height: 40px;" data-v-3d87c57a="" data-testid="detail-kost-facility__icon" alt="Jendela" class="detail-kost-facility-item__icon-image" data-src="https://static.mamikos.com/uploads/tags/PAsBbxrm.png" src="https://static.mamikos.com/uploads/tags/PAsBbxrm.png" lazy="loaded">
                                    @endif

                                    @if($fasilitas === 'Kasur')
                                    <img style="filter: grayscale(100%); width: 40px; height: 40px;" data-v-3d87c57a="" data-testid="detail-kost-facility__icon" alt="Kasur" class="detail-kost-facility-item__icon-image" data-src="https://static.mamikos.com/uploads/tags/Y4ZfXUdX.png" src="https://static.mamikos.com/uploads/tags/Y4ZfXUdX.png" lazy="loaded">
                                    @endif

                                    @if($fasilitas === 'TV')
                                    <img style="filter: grayscale(100%); width: 40px; height: 40px;" data-v-3d87c57a="" data-testid="detail-kost-facility__icon" alt="TV" class="detail-kost-facility-item__icon-image" data-src="https://static.mamikos.com/uploads/tags/ZYjIeqGp.png" src="https://static.mamikos.com/uploads/tags/ZYjIeqGp.png" lazy="loaded">
                                    @endif

                                    @if($fasilitas === 'Meja')
                                    <img style="filter: grayscale(100%); width: 40px; height: 40px;" data-v-3d87c57a="" data-testid="detail-kost-facility__icon" alt="Meja" class="detail-kost-facility-item__icon-image" data-src="https://static.mamikos.com/uploads/tags/nluOWsFG.png" src="https://static.mamikos.com/uploads/tags/nluOWsFG.png" lazy="loaded">
                                    @endif

                                    @if($fasilitas === 'Kipas Angin')
                                    <img style="filter: grayscale(100%); width: 40px; height: 40px;" data-v-3d87c57a="" data-testid="detail-kost-facility__icon" alt="Kipas Angin" class="detail-kost-facility-item__icon-image" data-src="https://static.mamikos.com/uploads/tags/gQ6hjpk3.png" src="https://static.mamikos.com/uploads/tags/gQ6hjpk3.png" lazy="loaded">
                                    @endif

                                    @if($fasilitas === 'Termasuk Listrik')
                                    <img style="filter: grayscale(100%); width: 40px; height: 40px;" data-v-3d87c57a="" data-testid="detail-kost-facility__icon" alt="Termasuk listrik" class="detail-kost-facility-item__icon-image" data-src="https://static.mamikos.com/uploads/tags/GIUdAv2J.png" src="https://static.mamikos.com/uploads/tags/GIUdAv2J.png" lazy="loaded">
                                    @endif

                                    @if($fasilitas === 'Wifi')
                                    <img style="filter: grayscale(100%); width: 40px; height: 40px;" data-v-3d87c57a="" data-testid="detail-kost-facility__icon" alt="WiFi" class="detail-kost-facility-item__icon-image" data-src="https://static.mamikos.com/uploads/tags/HAAjIo8D.png" src="https://static.mamikos.com/uploads/tags/HAAjIo8D.png" lazy="loaded">
                                    @endif

                                    @if($fasilitas === 'Mesin Cuci')
                                    <img style="filter: grayscale(100%); width: 40px; height: 40px;" data-v-3d87c57a="" data-testid="detail-kost-facility__icon" alt="Mesin Cuci" class="detail-kost-facility-item__icon-image" data-src="https://static.mamikos.com/uploads/tags/nFsJ8SPt.png" src="https://static.mamikos.com/uploads/tags/nFsJ8SPt.png" lazy="loaded">
                                    @endif
                        ...
                        <div class="flex border-t border-gray-300 mt-5 py-2 font-semibold">
                            <div class="w-full">
                                ...
                                <div class="font-normal flex items-center">
                                    ...
                                    <img style="filter: grayscale(100%); width: 40px; height: 40px;" data-v-3d87c57a="" data-testid="detail-kost-facility__icon" alt="Kloset Duduk" class="detail-kost-facility-item__icon-image" data-src="https://static.mamikos.com/uploads/tags/TyT47meW.png" src="https://static.mamikos.com/uploads/tags/TyT47meW.png" lazy="loaded">
                                    @endif

                                    @if($fasilitas === 'Shower')
                                    <img style="filter: grayscale(100%); width: 40px; height: 40px;" data-v-3d87c57a="" data-testid="detail-kost-facility__icon" alt="Shower" class="detail-kost-facility-item__icon-image" data-src="https://static.mamikos.com/uploads/tags/cbxCWmko.png" src="https://static.mamikos.com/uploads/tags/cbxCWmko.png" lazy="loaded">                                    
                                    @endif

                                    @if($fasilitas === 'Ember Mandi')
                                    <img style="filter: grayscale(100%); width: 40px; height: 40px;" data-v-3d87c57a="" data-testid="detail-kost-facility__icon" alt="Ember mandi" class="detail-kost-facility-item__icon-image" data-src="https://static.mamikos.com/uploads/tags/B71K93ll.png" src="https://static.mamikos.com/uploads/tags/B71K93ll.png" lazy="loaded">                                    
                                    @endif

                                    @if($fasilitas === 'Kloset Jongkok')
                                    <img style="filter: grayscale(100%); width: 40px; height: 40px;" data-v-3d87c57a="" data-testid="detail-kost-facility__icon" alt="Kloset Jongkok" class="detail-kost-facility-item__icon-image" data-src="https://static.mamikos.com/uploads/tags/7JtETpII.png" src="https://static.mamikos.com/uploads/tags/7JtETpII.png" lazy="loaded">
                                    @endif
