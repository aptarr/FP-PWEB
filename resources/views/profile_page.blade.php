                    ...
                    <div class="flex-col align-center ">
                        <div class="bg-white p-5 border-gray-300 border">
                            ...
                            <img src="{{ asset(Storage::url($user->image)) }}"
                                class="w-40 h-40 rounded-full bg-white border-2 mx-auto" alt="image-service">
                            @else
                            <img class="w-40 h-40 rounded-full bg-white border-2 mx-auto"
                                src="https://www.svgrepo.com/show/396909/letter-s.svg" alt="Rounded avatar">
                            @endif
                            <div class="text-3xl">
                        ...
                        <div class="w-full h-48 flex rounded border border-gray-300 my-5">
                            <div class="relative flex-shrink-0 w-48 h-48 overflow-hidden">
                                <a href="{{ route('service.show', ['id' => $service->id, 'user_id' => $service->user_id]) }}"
                                    ...
                                    <img src="{{ Storage::url($service->image) }}" class="object-cover w-full h-full"
                                        alt="image-service">
                                    @else
