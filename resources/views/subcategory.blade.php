                ...
                <div class="mt-10">
                    <div class="flex">
                        <div class="font-bold border border-gray-300 rounded-lg w-32 py-3 text-center tab inactive flex justify-center"
                            data-tab="budget">
                            Harga
                            <svg class="ml-2 h-6 w-6 text-black" width="24" height="24" viewBox="0 0 24 24"
                    ...
                    <div class="tab-content hidden mt-2 rounded-lg border border-gray-300 p-5 w-64" id="budgetContent"
                        ...
                        <input id="budgetValue" name="budgetHidden" class="hidden"
                            value="{{$budgetLower}}-{{$budgetUpper}}">
                        ...
                        <div class="mt-3 flex justify-center">
                            <a href="#" onclick="applyFilters()"
                                class="block px-2 py-1 hover:bg-gray-200 font-extrabold">
                                <button type="button"
                    ...
                    <div class="ml-36 tab-content hidden mt-2 rounded-lg border border-gray-300 p-5 w-64"
                        id="deliveryContent">
                        <input id="timeHidden" name="timeHidden" class="hidden" value="{{$time}}">
                        <div class="flex items-center">
                            <input id="default-radio-5" type="radio" value="1" name="time-radio"
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2">
                            <label for="default-radio-5" class="ms-2 text-base font-bold">Express 24H</label>
                        </div>
                        <div class="flex items-center mt-2">
                            <input checked id="default-radio-6" type="radio" value="3" name="time-radio"
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 ">
                            <label for="default-radio-6" class="ms-2 text-base font-bold ">Up to 3 days</label>
                        </div>
                        <div class="flex items-center mt-2">
                            <input checked id="default-radio-7" type="radio" value="7" name="time-radio"
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 ">
                            <label for="default-radio-7" class="ms-2 text-base font-bold ">Up to 7 days</label>
                        </div>
                        <div class="flex items-center mt-2">
                            <input checked id="default-radio-8" type="radio" value="999" name="time-radio"
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 ">
                            <label for="default-radio-8" class="ms-2 text-base font-bold ">Anytime</label>
                        </div>
                        <div class="mt-3 flex justify-center">
                            <a href="#" onclick="applyFiltersTime()"
                                class="block px-2 py-1 hover:bg-gray-200 font-extrabold">
                                <button type="button"
                                    class="text-white bg-[#050708] hover:bg-[#050708]/90 focus:ring-4 focus:outline-none focus:ring-[#050708]/50 font-medium rounded-md text-sm px-20 py-2.5 text-center inline-flex items-center dark:focus:ring-[#050708]/50 dark:hover:bg-[#050708]/30">
                                    Apply
                    ...
                    <div class="w-full mt-4 p-4">
                        ...
                        && $service->harga_per_bulan <= $budgetUpper; }); $servicesChunks=$filteredServices->chunk(5);
                            @endphp
